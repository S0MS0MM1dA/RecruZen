    ...
    <aside class="sidebar-div">
      <div class="sidebar-container">
        ...
        <nav class="sidebar-menu-div">
          ...
          <div class="dash-btn">
            <a href="../../profile/userprofile.php"><i class="fa-solid fa-user"></i><span>Profile</span></a>
          </div>
          <div class="dash-btn">
            <a href="../jobs/job.php"
          ...
          <div class="dash-btn">
            <a href="../../dashboard/jobseeker/saveJobs.php"
              ><i class="fa-solid fa-bookmark"></i><span>Saved Jobs</span></a
            >
          </div>
          <div class="dash-btn">
            <a href="../dashboard/jobseeker/appliedJobs.php">
